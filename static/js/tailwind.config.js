module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Primary Colors - Deep academic authority, institutional trust
        primary: {
        ...
        // Secondary Colors - Haitian earth warmth, cultural authenticity
        secondary: {
        ...
        // Accent Colors - Achievement celebration, urgent action guidance
        accent: {
