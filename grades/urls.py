...
urlpatterns = [
    ...
    path('section/<int:section_id>/grade-entry/', views.grade_entry_view, name='professor_grade_entry'),
    path('grade/<int:grade_id>/edit/', views.grade_edit_professor, name='professor_grade_edit'),
    ...
    # Admin
    path('', views.grade_list_view, name='admin_grade_list'),
